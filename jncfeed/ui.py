...
def login_window():
    layout = [
        [sg.Image(data_base64=jnc_logo), sg.Image(data_base64=jnc_title)],
        [
            sg.Text("Email", size=(8, 1), font=("Roboto", 12)),
            sg.Input(key="-email-", size=(30, 1), font=("Roboto", 12)),
        ],
        [
            sg.Text("Password", size=(8, 1), font=("Roboto", 12)),
            sg.Input(
                key="-password-", password_char="*", size=(30, 1), font=("Roboto", 12)
            ),
        ],
        [
            sg.OK(font=("Roboto", 12), size=(8, 1)),
            sg.Cancel(font=("Roboto", 12), size=(8, 1)),
        ],
    ]
    # Create the window
    window = sg.Window(
